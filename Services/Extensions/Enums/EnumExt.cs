namespace UniversalComputerInventory.Services.Extensions.Enums
{
	public static class EnumExt
	{

		public static Type GT(this Enum source) => source.GetType();
		/// <summary>
		...
		public static string[] GetBaseNames(this Enum source) => Enum.GetNames(source.GT());
		...
		public static TEnum[] GetBaseValues<TEnum>(this Enum source) where TEnum : Enum => (TEnum[])Enum.GetValues(source.GT());
		/// <inheritdoc cref="GetBaseValues{TEnum}(Enum)"/>
		public static TEnum[] GetBaseValues<TEnum>(this TEnum source) where TEnum : Enum => (TEnum[])Enum.GetValues(source.GT());
		/// <inheritdoc cref="GetBaseNames{TEnum}(TEnum)"/>
		/// <summary>
		/// Gets the values within the given <typeparamref sel="TEnum"/>.
		/// </summary>
